...
import phoneImg from "../../public/png-phone.svg";
import call from "../../public/call.svg";
import lock from "../../public/lock.svg";
import phoeDash from "../../public/png-phone.svg";
import download from "../../public/download.svg";
import bgTop from "../../public/bgtop.jpg";
import bnb from "../../public/bnb.svg";
import cannon from "../../public/canon.svg";
import dell from "../../public/dell.svg";
import microsoft from "../../public/microsoft.svg";
import dropbox from "../../public/dropbox.svg";
import hm from "../../public/hm.svg";
import pp from "../../public/sherina.svg";
          ...
          <section className=" flex px-[10%] lg:px-[8%] xl:px-[10%] bg-white   relative flex-col hero-home lg:bg-none pb-[11rem] lg:pb-[2rem] ">
            ...
            <section className=" mt-[6.5rem] xl:mt-[8.8rem] flex justify-between gap-[3.6rem] xl:gap-0 ">
              <section className=" flex flex-col gap-11">
                ...
                <button className="bg-blue-500 lg:bg-primary  font-extrabold w-[10.813rem] h-[3.563rem] rounded-xl text-primary lg:text-white hover:bg-primary border-2 border-white hover:border-white hover:border-[3px]">
                  Try it Free
                </button>
              </section>
